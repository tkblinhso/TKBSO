      ...
      const activities: LessonActivity[] = [
        {
          ...
          teacherActivity: `• Bắt nhịp bài hát tập thể vui nhộn hoặc tổ chức trò chơi nhỏ khởi động tạo không khí cởi mở, ấm áp cuối tuần.`,
...
- Vỗ tay chúc mừng các bạn được tuyên dương.`
        ...
        {
          name: "3. Sinh hoạt theo chủ đề tuần (12 đến 15 phút)",
          objective: `Thực hiện hoạt động trải nghiệm theo chủ đề: "${lessonTitle}".`,
          teacherActivity: `• Tổ chức sinh hoạt chủ đề:
- Giới thiệu nội dung sinh hoạt chủ đề tuần: "${lessonTitle}".
- Hướng dẫn học sinh thảo luận nhóm, chia sẻ những việc làm tốt đã làm trong tuần hoặc tham gia trò chơi / biểu diễn văn nghệ theo chủ đề.
- Nhận xét và chốt lại thông điệp ý nghĩa của buổi sinh hoạt.`,
          studentActivity: `• Tích cực tham gia sinh hoạt chủ đề:
- Làm việc theo tổ/nhóm: Chia sẻ những câu chuyện hay, những việc tốt đã làm.
- Tham gia các trò chơi, đố vui hoặc biểu diễn các tiết mục văn nghệ giao lưu vui vẻ.`
        },
        {
          name: "4. Phương hướng tuần mới & Dặn dò (3 đến 5 phút)",
          objective: "Xác định rõ các mục tiêu, nhiệm vụ tuần tới và dặn dò an toàn cuối tuần.",
          teacherActivity: `• Phổ biến phương hướng tuần tới:
- Nêu rõ các mục tiêu cần phấn đấu trong tuần sau.
- Phân công nhiệm vụ cụ thể cho từng tổ (trực nhật, chăm sóc bồn hoa, chuẩn bị đồ dùng).
• Dặn dò an toàn:
- Nhắc nhở học sinh nghỉ ngơi cuối tuần an toàn, phòng tránh đuối nước, giữ gìn vệ sinh và phụ giúp bố mẹ việc nhà.`,
