...
import { DAYS_OF_WEEK, calculateWeekDateRange, getWeekDates } from "../data/defaultTimetables";
import { 
  FileDown, 
  Plus, 
  Trash2, 
                      ...
                      >
                        ...
                        <td className="py-2.5 px-4 border-r border-black">
                          {isEditing ? (
                            ...
                            <div className="font-semibold text-black leading-snug">{cleanLessonTitle(item.lessonTitle) || (isEn ? "Lesson" : "Bài dạy")}</div>
                          )}
                        </td>
